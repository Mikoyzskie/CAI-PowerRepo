    ...
    <div id="gb-main-bar-content" class="page-content collapsible-bar-1 pl-5 pr-5 pb-2">
        ...
        <div class="row c28723">
            <div class="col-12 c28731 col-md-12 col-sm-12 col-xl-8 col-lg-8 ">
                <h2 data-type="header" id="ikjko3">Edit Lesson </h2>
                <hr />
                <div class="card">
                    <div class="card-body">

                    <?php if(!empty($lessons)):?>
                    <?php foreach($lessons as $key):?>


                        <form id="lessonform" method="post" action="<?= base_url('admin/update_lessson');?>?id=<?= $key->id;?>" enctype="multipart/form-data">
                            <div class="form-group"><label for="productName">Lesson Title:</label><input type="text" placeholder="Simply Name the Lesson" class="form-control" required name="title" value="<?= $key->title;?>"/></div>
                            <div class="form-group"><label for="exampleInputName">YouTube Embedded URL:</label><input type="text" placeholder="https://www.youtube.com/embed/" class="form-control" required name="youtube" value="<?= $key->vid_link;?>"/></div>
                            <p><i class="text-secondary">*Get youtube embedded link on the share button and Embedded option then copy the link</i></p>
                            <div class="form-group"><label for="exampleInputMessage">Lesson Description:</label><textarea maxlength="128" name="message" rows="5" class="form-control" required><?= $key->short_description;?></textarea></div>

                            <div class="form-group"><label for="exampleInputName">Achievements:</label><input type="text" placeholder="Concise & Descriptive Achievement of the Lesson" class="form-control" name="achieve" value="<?= $key->achievement;?>"/>
                            </div>
                            <div class="form-group"><label for="exampleInputName">Font Awesome Icon:</label><input type="text" placeholder="fa-fire" class="form-control" name="icon" value="<?= $key->icon;?>"/></div>
                            <p><i class="text-secondary">*Visit the font awesome website https://fontawesome.com/icons/ for Achievement Icon</i></p>
                            <h5 data-type="header" class="card-title">Current Thumbnail</h5>
                            <div class="col-md-2 col-2"><img data-type="image" src="<?=base_url('public/uploads');?>/<?= $key->thumb;?>" alt="..." class="card-img product-img" /></div>
                            <div class="form-group"><label for="exampleInputName">Thumbnail(1:1 square):</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" class="custom-file-input" name="thumb"/><label for="inputGroupFile01"
                            ...
                            <div class="form-group"><label for="exampleInputName">Available:</label>
                                ...
                                <?php else:?>
                                    ...
                                    <div class="checkbox switcher"><label for="test1"><input type="checkbox" id="test1" name="avail"/><span><small></small></span><small>Yes</small></label></div>
                                <?php endif;?>
                            </div>
