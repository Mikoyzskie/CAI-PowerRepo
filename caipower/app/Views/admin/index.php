    ...
    <div id="gb-main-bar-content" class="page-content collapsible-bar-1 pl-5 pr-5 pb-2">
        ...
        <div class="row">
            <div class="col-xl-3 col-md-6 mb-3 mb-lg-0">
                <div class="border rounded">
                    <div class="d-flex border-bottom p-3 w-100 align-items-center">
                        <h3 class="h5 mr-auto mb-0">Total Users </h3>
                        <p class="badge badge-success mb-0">Users </p>
                    </div>
                    <p class="px-3 pt-4 h3">
                    ...
                    <p class="mr-auto">Non-Administrator Users </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 mb-3 mb-lg-0">
                <div class="border rounded">
                    <div class="d-flex border-bottom p-3 w-100 align-items-center">
                        <h3 class="h5 mr-auto mb-0">Total Admin </h3>
                        <p class="badge badge-success mb-0">Administrators </p>
                    </div>
                    <p class="px-3 pt-4 h3"><?php if(!empty($admins)):?>
                                    <?php foreach($admins as $counts):?>
                                        <?= $counts->adminCount;?>
                                    <?php endforeach;?>
                                    <?php else:?>
                                    <?php endif;?> </p>
                    <div class="d-flex px-3 w-100">
                        <p class="mr-auto">Teachers / Administrators</p>
            ...
            <div class="col-xl-3 col-md-6 mb-3 mb-lg-0">
                <div class="border rounded">
                    <div class="d-flex border-bottom p-3 w-100 align-items-center">
                        <h3 class="h5 mr-auto mb-0">Total Lesson </h3>
                        <p class="badge badge-warning mb-0">Lesson </p>
                    </div>
                    <p class="px-3 pt-4 h3">
                    <?php if(!empty($lessoncount)):?>
                    <?php foreach($lessoncount as $counts):?>
                                        <?= $counts->NumberOfLesson;?>
                                    <?php endforeach;?>
                                    <?php else:?>
                                    <?php endif;?>
                    </p>
                    <div class="d-flex px-3 w-100">
                        <p class="mr-auto">Questions </p>
                        <?php if(!empty($quests)):?>
                    <?php foreach($quests as $counts):?>
                                        
                                    
                        
                        <p class="text-success d-flex align-items-center"><?= $counts->NumberOfQuest;?> </p>
                        <?php endforeach;?>
                                    <?php else:?>
                                    <?php endif;?>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="border rounded">
                    <div class="d-flex border-bottom p-3 w-100 align-items-center">
                        <h3 class="h5 mr-auto mb-0">Event Logs </h3>
                        <p class="badge badge-danger mb-0">Events </p>
                    </div>
                    <p class="px-3 pt-4 h3">
                    <?php if(!empty($events)):?>
                    <?php foreach($events as $counts):?>
                                        <?= $counts->NumberOfEvents;?>
                                    <?php endforeach;?>
                                    <?php else:?>
                                    <?php endif;?>
                    </p>
                    <div class="d-flex px-3 w-100">
                        <p class="mr-auto">Updates / Events</p>
                ...
                <div class="col-12">
                    ...
                    <div class="header mt-md-5">
                        <div class="header-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="<?= base_url('admin/user');?>" class="btn btn-primary lift"> New User </a>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <div class="row align-items-center">
                                <div class="col">
                                    <form class="row align-items-center mt-1" autocomplete="off" action="<?= base_url('admin/searchuser')?>">
                                    ...
                                    <tr class ="ml-4">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown"><a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                ...
                                                <?php if($user['attempt'] == 3):?>
                                                    <a href="<?= base_url('admin/unlock')?>?id=<?= $user['code'];?>" class="dropdown-item"> Unlock </a>
                                                <?php else:?>
                                                <a href="<?= base_url('admin/edit_user')?>?id=<?= $user['code'];?>" class="dropdown-item"> Edit </a>
                                                <?php endif;?>                                       
                                                <a class="dropdown-item deletebtn" data-toggle="modal" data-target="#deletemodal" style="cursor: pointer;"> Delete </a>
