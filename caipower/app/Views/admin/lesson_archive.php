                ...
                <div class="col-12">
                        ...
                        <div class="header-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <h1 class="header-title"> Lessons </h1>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <div class="row align-items-center">
                                <div class="col">
                                    <form class="row align-items-center mt-1" action="<?= base_url('admin/searchlesson')?>">
                            ...
                            <table class="table table-sm table-nowrap card-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href="#" data-sort="orders-product" class="text-muted sort"> Title </a></th>
                                        <th><a href="#" data-sort="orders-date" class="text-muted sort"> YouTube Link </a></th>
                                        <th><a href="#" data-sort="orders-date" class="text-muted sort"> Achievement </a></th>
                                        <th><a href="#" data-sort="orders-total" class="text-muted sort"> Status </a></th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr class ="ml-4">
                                        ...
                                        <td class="orders-product"> <?= $key['title'];?> </td>
                                        <td class="orders-product"> <?= $key['vid_link'];?> </td>
                                        <td class="orders-date"><?= $key['achievement'];?></td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown"><a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                ...
                                                <?php $id = $key['id'];?>
                                                <a href="<?= base_url('admin/edit_lesson');?>?id=<?php echo $id;?>" class="dropdown-item"> Edit </a>
                                                
                                                <a class="dropdown-item deletebtn" data-toggle="modal" data-target="#deletemodal" style="cursor: pointer;"> Restore </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Restore Lesson</h2>
                    <button type="button" class="close" data-dismiss="modal">
                        <span>&times;</span>
                    </button>
                </div>
                <form action="<?= base_url('admin/restore_lesson')?>" method="POST">
                <div class="modal-body">
                    <input type="hidden" name="delete_id" id="delete_id"/>
                    <input type="hidden" name="delete_name" id="delete_name"/>
                    <p>Are you sure you want to restore this lesson?</p>
                </div>
