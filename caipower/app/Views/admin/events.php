                ...
                <div class="col-12">
                        ...
                        <div class="header-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    ...
                                    <h1 class="header-title"> Event Logs </h1>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <div class="row align-items-center">
                                <div class="col">
                                    <form class="row align-items-center mt-1" action="<?= base_url('admin/searchevent')?>">
                            ...
                            <table class="table table-sm table-nowrap card-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href="#" data-sort="orders-product" class="text-muted sort"> Event </a></th>
                                        <th><a href="#" data-sort="orders-date" class="text-muted sort"> Description </a></th>
                                        <th><a href="#" data-sort="orders-date" class="text-muted sort"> Timestamp </a></th>
                                ...
                                <tbody class="list">
                                    ...
                                    <tr class ="ml-4">
                                        ...
                                        <td class="orders-product"> <?= $key['event'];?> </td>
                                        <td class="orders-product"> <?= $key['description'];?> </td>
                                        <td class="orders-date"><?= $key['time'];?></td>
                                    </tr>
                                    <?php endforeach;?>
                                    <?php else:?>
                                    <?php endif;?>
