    ...
    <div id="gb-main-bar-content" class="page-content collapsible-bar-1 pl-5 pr-5 pb-2">
        ...
        <div class="row c28723">
            <div class="col-12 c28731 col-md-12 col-sm-12 col-xl-8 col-lg-8 mx-auto">
                <h2 data-type="header" id="ikjko3">Edit User </h2>
                <hr />
                <div class="card">
                    <div class="card-body">
            ...
            <?php if(!empty($user)):?>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-xl-5 col-lg-5">
                        ...
                        <?= csrf_field();?>
                            ...
                            <div class="form-group"><label for="exampleInputMessage">Bio:</label><textarea maxlength="128" name="message" rows="3" class="form-control" ><?= $key->bio;?></textarea></div>
