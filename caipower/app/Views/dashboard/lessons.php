        ...
        <div class="container"><a href="<?= site_url('dashboard/');?>" class="navbar-brand"><svg width="40" height="40" version="1.1" viewBox="-44.4 -13.7 595 319" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active"><a href="#" class="nav-link">Lessons</a></li>
                    <li class="nav-item"><a href="<?= site_url('dashboard/mates');?>" class="nav-link">Mates</a></li>
                </ul>
                <form class="form-inline my-2 my-lg-0"  action="<?= base_url('dashboard/search')?>"><input placeholder="Search" aria-label="Search" type="search" class="form-control mr-sm-2" name="search"/><button type="submit"
...
<div class="container c28464">
        <div class="row c28723">
            <div class="col-xl-8 col-lg-8 col-12 c28731 col-md-12 col-sm-12">
                <h2 data-type="header" id="i57nga4">Lessons </h2>
                <hr />
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 c28774 d-xs-none d-sm-none d-lg-block d-xl-block d-md-none">
                ...
                <?php foreach($doneLess as $key):?>
                    <div class="card-body">
                        <h5 data-type="header" class="card-title">
                        <?= $key->title?>.  </h5><a href="<?= base_url('dashboard/watch')?>?id=<?= $key->id?>" class="btn btn-outline-secondary btn-sm">Retake Lesson</a>
                    </div>
                    <?php endforeach;?>
                    <?php else:?>
                        <div class="media-body">
                                <h5 data-type="header" class="mt-0 mb-1">Empty </h5><p class="text-secondary"> Want to start anytime now? Do something! Watch lessons!</p>
                            </div>
                    <?php endif;?>
