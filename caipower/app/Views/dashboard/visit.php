        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-12 col-md-12 col-sm-12 col-xl-3 col-lg-3">
                    ...
                    <p data-type="paragraph" class="text-center"><img width="150" height="150" data-type="image" src="<?=base_url('public/uploads');?>/<?= $key->profile;?>" id="iwm39a" /></p>
    ...
    <div class="container c28464">
        <div class="row c28723">
            ...
            <i class="fas <?= $key->icon?>"></i>
                    ...
                    <?php endforeach;?>
                    <?php else:?>
                        <i><h4 class="text-secondary"> No Achievements yet!</h4></i>
                    <?php endif;?>
                </div>
            </div>
